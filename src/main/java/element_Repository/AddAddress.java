...
public class AddAddress  extends BasePage{
	...
	@FindBy(xpath = "/html/body/div[1]/section[2]/div/section/div/div/a/button")
	...
	public WebElement getSubmitAddressButton() {
		return submitAddressButton;
	}

	public void performAddAddress(String name, String houseInfo,String streetInfo,String landmark,
